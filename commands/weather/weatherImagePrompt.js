...
function buildWeatherImagePrompt({ condition, temp, windSpeed, windDir, humidity }) {
	...
	return [
		...
		`Single wide shot of sky and horizon, natural lighting, detailed clouds and atmosphere. Looks like it's in Barovia. Randomly choose whether there are buildings, trees, or other structures in the scene.`,
