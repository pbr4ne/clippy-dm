...
const {
  ...
  pickSurname,
  pickWeightedGender
} = require(path.join(process.cwd(), 'commands', 'name', 'nameUtil.js'));

const { generateHair, formatHair } = require(path.join(process.cwd(), 'commands', 'npc', 'hairUtil.js'));
const { generateEyes } = require(path.join(process.cwd(), 'commands', 'npc', 'eyeUtil.js'));
const { pickTrait, pickBeardTrait } = require(path.join(process.cwd(), 'commands', 'npc', 'traitUtil.js'));
